...
<div class=" col-md-4 vertical-menu">
    ...
    <div class="col-md-10 relative" style="padding-bottom:40px; padding-left:10%" >             
        <div style="text-align: center;  ">
            <b><h3 style="font-family: Cooper; ">Corruption complaint</h3></b>
            <p><font color="green">Your Complaint SuccessFully Filed!!!</font></p>
        </div>
          
        <div>
            <form class="login-form" name="name" method="post" action="file_complaint_corruption_action.jsp">
